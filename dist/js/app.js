 ...
 */
    ...
    (() => {
        ...
        document.querySelectorAll(".product__content").forEach((n => {
            new core(n.querySelector(".product__slider"), {
        ...
        if (document.querySelector(".product-catalog")) new core(".product-catalog", {
            modules: [ Navigation, Pagination ],
            observer: true,
            observeParents: true,
            slidesPerView: 1,
        ...
        if (document.querySelector(".top-product-card__slider")) new core(".top-product-card__slider", {
            modules: [ Navigation, Pagination ],
            observer: true,
            observeParents: true,
            slidesPerView: 1,
        ...
        document.querySelectorAll(".tabs__body").forEach((n => {
            new core(n.querySelector(".areas-application__slider"), {
                modules: [ Navigation, Pagination ],
                observer: true,
                observeParents: true,
        ...
        function menuInit() {
            if (document.querySelector(".menu__icons")) document.addEventListener("click", (function(e) {
                if (bodyLockStatus && e.target.closest(".menu__icons")) {
                    bodyLockToggle();
        ...
        class SelectConstructor {
                ...
                if (targetElement.closest(this.getSelectClass(this.selectClasses.classSelect)) || targetElement.closest(this.getSelectClass(this.selectClasses.classSelectTag))) {
                    ...
                    if ("click" === targetType) {
                        if (!originalSelect.disabled) if (targetElement.closest(this.getSelectClass(this.selectClasses.classSelectTag))) {
                            ...
                            const optionItem = document.querySelectorAll(`.${this.selectClasses.classSelect}[data-id="${targetTag.dataset.selectId}"] .select__option[data-value="${targetTag.dataset.value}"]`);
            ...
            selectAction(selectItem) {
                ...
                if (!selectOptions.classList.contains("_slide")) selectItem.classList.toggle(this.selectClasses.classSelectOpen);
            }
 ...
 */
        ...
        const inputmask_data = document.querySelectorAll(".tel");
        if (inputmask_data) Inputmask({
        ...
        if (myVideos) myVideos.forEach((myVideo => {
            myVideo.addEventListener("click", (function(e) {
                let parent = e.target.parentNode;
                if (parent.classList.contains("_active")) parent.classList.remove("_active"); else parent.classList.add("_active");
        ...
        function paralaxScroll() {
            if (pageAbout) {
                ...
                window.addEventListener("scroll", (function(e) {
                    ...
                    if (scroll > res && scroll) pageAboutStones_1.classList.add("_active"); else pageAboutStones_1.classList.remove("_active");
                    if (scroll > res_2 && scroll) pageAboutStones_2.classList.add("_active"); else pageAboutStones_2.classList.remove("_active");
                }));
            }
        }
        paralaxScroll();
