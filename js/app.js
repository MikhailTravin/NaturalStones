 ...
 */        !function(e, t) {
        ...
        if (document.querySelector(".areas-application__slider")) new core(".areas-application__slider", {
            modules: [ Navigation, Pagination ],
            observer: true,
            observeParents: true,
            slidesPerView: 1,
            ...
            preloadImages: true,
            navigation: {
                prevEl: ".areas-application__arrow-prev",
                nextEl: ".areas-application__arrow-next"
            }
        });
